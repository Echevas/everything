      ...
      <div className="flex-1 overflow-auto px-6 py-6">
        <div className="space-y-4">
          ...
          <p className="text-gray-700">
            Welcome to Echo Extension Template! This extension provides seamless
            authentication for accessing AI resources like OpenAI, Anthropic,
            and more through the Echo platform.
          </p>
